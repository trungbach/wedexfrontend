...
import { Text, Flex, Box, ErrorIcon, Button } from 'wedex-uikit/src'
    ...
    >
      <Box ml="48px">
        <Text color="warning" bold>
          You must complete migration if you want to keep earning from any Wedex LP tokens and Wedex farms.
        </Text>
