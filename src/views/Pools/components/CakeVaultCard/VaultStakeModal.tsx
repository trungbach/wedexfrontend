...
import { Modal, Text, Flex, Image, Button, Slider, BalanceInput, AutoRenewIcon } from 'wedex-uikit/src'
...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({ pool, stakingMax, isRemovingStake = false, onDismiss }) => {
  ...
  const handleWithdrawal = async (convertedStakeAmount: BigNumber) => {
    ...
    // trigger withdrawAll function if the withdrawal will leave 0.000001 WEX or less
