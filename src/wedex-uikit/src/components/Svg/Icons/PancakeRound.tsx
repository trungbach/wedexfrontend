...
const Svg = styled.svg<SvgProps>`
  ...
  .st296 {
    opacity: 0.62;
    clip-path: url(#XMLID_738_);
    fill: url(#XMLID_739_);
  }

  .st297 {
    opacity: 0.84;
    clip-path: url(#XMLID_740_);
    fill: url(#XMLID_741_);
  }
...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox='0 0 24 24' {...props}>
      <g>
        <path className='st343' d='M9.3,6.2C9.1,6,8.9,5.2,8.7,5C7.5,3.7,6.4,2.4,6.5,1.6C6.6,0.1,10,2.5,10,2.5S9.9,0,11.7,0
        ...
        <path className='st344'
          d='M6.5,15.1c0,2.3,1.9,4.2,4.2,4.2c2.3,0,4.2-1.9,4.2-4.2c0-2.3-1.9-4.2-4.2-4.2C8.4,10.9,6.5,12.8,6.5,15.1z'
        />
        <path className='st345' d='M12.8,16.1c0-1.1-1.2-1.3-1.2-1.3c-0.2,0-0.3,0-0.5,0v-1.7c0.7,0.2,0.4,0.8,0.4,0.8h1c0,0,0.4-1.6-1.5-1.9
        ...
        <path className='st346' d='M21.6,15.3c-0.6-4.6-2.8-7.3-6.1-8.7c-0.1,0-0.1,0-0.2,0h0c-0.4-0.2-0.8-0.3-1.2-0.5
        ...
        <path className='st344' d='M15.4,6.6H8.1c0.4-0.3,0.8-1.4,0.5-1.8h6.4C14.7,5.2,15,6.3,15.4,6.6z' />
      </g>
    </Svg>
  )
}
