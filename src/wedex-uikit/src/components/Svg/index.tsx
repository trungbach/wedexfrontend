...
export { default as BtcUsdtPairToken } from "./Icons/BtcUsdtPairToken";
...
export { default as TeamFarmingIcon } from "./Icons/TeamFarming";
export { default as InvestmentIcon } from "./Icons/Investment";
export { default as CommissionIcon } from "./Icons/Commission";
export { default as NftCommissionIcon } from "./Icons/NftCommission";
