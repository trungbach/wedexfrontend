...
const Svg = styled.svg<SvgProps>`
  ...
  .st0{fill:#49A341;}
   ...
   .st344{font-size:22px;}
   .st345{fill:#75BD38;}
   .st346{fill:#474656;}
   .st347{fill:#E5E5E5;}
   .st348{opacity:0.5;fill:#598E38;}
   .st349{opacity:0.55;fill:#598E38;}
   .st350{fill:#D21B00;}
   .st351{fill:#F65138;}
   .st352{opacity:0.67;fill:#B35C45;}
   .st353{fill:#5C5248;}
   .st354{fill:#51555D;}
   .st355{fill:#F86F5B;}
   .st356{opacity:0.15;}
...
const Logo: React.FC<LogoProps> = ({isDark, ...props}) => {
  ...
  return (
    <Svg viewBox="0 0 160 26" {...props}>
      <g>
        <g>
          <polygon className="st0" points="18.5,5.3 18.5,14.1 11.5,9.9 11.3,9.8 11.1,9.9 3.9,14.2 3.9,5.3 0,7.6 0,20.5 0.2,20.4 0.2,20.5
			11.3,13.9 22.4,20.5 22.4,16.4 22.4,7.6 		"/>
          <polygon className="st0" points="11.3,1 7.2,3.5 7.2,7.5 7.6,7.5 11.3,5.3 15,7.5 15.2,7.5 15.2,3.3 		"/>
          <polygon className="st0" points="11.3,23.4 7.6,25.6 4.2,23.2 11.3,18.9 18.4,23.2 15,25.6 		"/>
          <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="-2.7828" y1="15.7147" x2="10.3523" y2="8.1312">
            <stop offset="0" style={{stopColor: '#49A341'}}/>
            <stop offset="0.4294" style={{stopColor: '#4BA543'}}/>
            <stop offset="0.6118" style={{stopColor: '#52AA4A'}}/>
            <stop offset="0.7474" style={{stopColor: '#5FB455'}}/>
            <stop offset="0.8598" style={{stopColor: '#70C166'}}/>
            <stop offset="0.9568" style={{stopColor: '#87D37B'}}/>
            <stop offset="1" style={{stopColor: '#94DD87'}}/>
          </linearGradient>
          <polygon className="st1" points="11.3,9.8 11.3,9.8 11.1,9.9 3.9,14.2 3.9,7.5 0.2,7.5 0,7.6 0,20.5 0.2,20.4 0.2,20.5 11.3,13.9
			11.3,13.9 		"/>
          <polygon className="st0" points="18.5,8.1 18.5,14.1 11.5,9.9 11.3,9.8 11.3,13.9 22.4,20.5 22.4,16.4 22.4,8.1 		"/>
          <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="1.9505" y1="5.2821" x2="1.9505" y2="20.5347">
            <stop offset="0" style={{stopColor: '#A9F99D'}}/>
            <stop offset="1.426244e-002" style={{stopColor: '#A3F498'}}/>
            <stop offset="9.603477e-002" style={{stopColor: '#87DB7D'}}/>
            <stop offset="0.1886" style={{stopColor: '#70C667'}}/>
            <stop offset="0.2946" style={{stopColor: '#5FB656'}}/>
            <stop offset="0.4226" style={{stopColor: '#52AB4A'}}/>
            <stop offset="0.5948" style={{stopColor: '#4BA543'}}/>
            <stop offset="1" style={{stopColor: '#49A341'}}/>
          </linearGradient>
          <polygon className="st2" points="3.9,18.3 3.9,14.2 3.9,14.2 3.9,5.3 0,7.6 0,20.5 0.2,20.4 0.2,20.5 		"/>
          <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="20.4651" y1="5.2821" x2="20.4651" y2="20.5347">
            <stop offset="0" style={{stopColor: '#A9F99D'}}/>
            <stop offset="1.426244e-002" style={{stopColor: '#A3F498'}}/>
            <stop offset="9.603477e-002" style={{stopColor: '#87DB7D'}}/>
            <stop offset="0.1886" style={{stopColor: '#70C667'}}/>
          ...
          <polygon className="st3" points="18.5,14.1 18.5,14.1 18.5,18.2 22.4,20.5 22.4,16.4 22.4,7.6 18.5,5.3 		"/>
          <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="11.2146" y1="4.2947" x2="7.1746" y2="4.2947">
            <stop offset="0" style={{stopColor: '#94DD87'}}/>
            <stop offset="4.324311e-002" style={{stopColor: '#87D37B'}}/>
            <stop offset="0.1402" style={{stopColor: '#70C166'}}/>
            <stop offset="0.2526" style={{stopColor: '#5FB455'}}/>
            <stop offset="0.3882" style={{stopColor: '#52AA4A'}}/>
            <stop offset="0.5706" style={{stopColor: '#4BA543'}}/>
            <stop offset="1" style={{stopColor: '#49A341'}}/>
          </linearGradient>
          <polygon className="st4" points="11.2,1.1 7.2,3.5 7.2,7.5 7.6,7.5 11.2,5.3 		"/>
          <linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="11.3116" y1="22.2376" x2="4.2228" y2="22.2376">
            <stop offset="0" style={{stopColor: '#94DD87'}}/>
            <stop offset="4.692155e-002" style={{stopColor: '#84D178'}}/>
            <stop offset="0.1306" style={{stopColor: '#6EC064'}}/>
            <stop offset="0.2295" style={{stopColor: '#5DB354'}}/>
            <stop offset="0.3519" style={{stopColor: '#52AA49'}}/>
            <stop offset="0.5235" style={{stopColor: '#4BA443'}}/>
            <stop offset="1" style={{stopColor: '#49A341'}}/>
          </linearGradient>
          <polygon className="st5" points="11.3,18.9 11.3,18.9 4.2,23.2 7.6,25.6 11.3,23.4 11.3,23.4 		"/>
        </g>
        <text transform="matrix(1 0 0 1 29.0792 18.8849)" className="st343 st344" fill={textColor}>WEDEX.APP
        </text>
      </g>
    </Svg>
  );
