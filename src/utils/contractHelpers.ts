...
import {
  ...
  getMulticallAddress,
  getpresaleAddress, getUsdtAdress,
  getWexNftAddress, getRecordReferralAdress, getOldMasterChefAddress, getV2MasterChefAddress, getV3MasterChefAddress,
} from 'utils/addressHelpers'

// ABI
import profileABI from 'config/abi/pancakeProfile.json'
import referralABI from 'config/abi/wexReferral.json'
import wedNftABI from 'config/abi/wexNft.json'
...
import oldMasterChef from 'config/abi/oldmasterchef.json'
...
export const getUsdtContract = (web3?: Web3) => {
  return getContract(cakeAbi, getUsdtAdress(), web3)
}
export const getProfileContract = (web3?: Web3) => {
  return getContract(profileABI, getPancakeProfileAddress(), web3)
}
export const getReferralContract = (web3?: Web3) => {
  return getContract(referralABI, getWexReferralAddress(), web3)
}
export const getWexNftContract = (web3?: Web3) => {
  return getContract(wedNftABI, getWexNftAddress(), web3)
}
...
export const getRecordReferralContract = (web3?: Web3) => {
  return getContract(recordReferralAbi, getRecordReferralAdress(),web3)
}
...
export const getOldMasterchefContract = (web3?: Web3) => {
  return getContract(masterChef, getOldMasterChefAddress(), web3)
}
export const getV2MasterchefContract = (web3?: Web3) => {
  return getContract(v2MasterChef, getV2MasterChefAddress(), web3)
}
export const getV3MasterchefContract = (web3?: Web3) => {
  return getContract(v2MasterChef, getV3MasterChefAddress(), web3)
}
